...
async function run() {
  const queries = [
    'P C Abraham Kunjettan Cherupushpa',
    'Abraham Pallattukunnel CML founder',
    'Kunjettan Pallattukunnel CML direct link'
  ];
  ...
  for (const query of queries) {
    ...
    try {
      ...
      console.log(`Found ${matches.length} matches representation.`);
